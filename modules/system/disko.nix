{ ... }: {
  flake.nixosModules.disk = { lib, config, ... }: {
    imports = [ (import ./_disk-layout.nix { device = config.custom.disk.device; }) ];
  ...
  flake.diskoConfigurations = {
    vm = import ./_disk-layout.nix { device = import ./hosts/vm/_device.nix; };
    desktop = import ./_disk-layout.nix { device = import ./hosts/desktop/_device.nix; };
    generic = import ./_disk-layout.nix { device = import ./hosts/generic/_device.nix; };
  };
}
